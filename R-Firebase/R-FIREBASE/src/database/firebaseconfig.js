...
export {db, addDoc, collection, doc, updateDoc, deleteDoc, auth, createUserWithEmailAndPassword, onAuthStateChanged, signInWithEmailAndPassword, signOut, deleteUser, query, where, getDocs};